...
public class MyAnimationDrawable {
    private static MyAnimationDrawable animationDrawable;
    ...
    public static MyAnimationDrawable getAnimationDrawable(){
    ...
    public MyAnimationDrawable animateRawManuallyFromXML(int resourceId,
                                                         final ImageView imageView, final Runnable onStart,
                                                         final Runnable onComplete) {
        animateRawManuallyFromXML(resourceId,imageView,false,onStart,onComplete);
        return this;
    }

    public MyAnimationDrawable animateRawManuallyFromXML(int resourceId,
                                                         final ImageView imageView, final boolean loop, final Runnable onStart,
                                                         final Runnable onComplete) {
        loadRaw(resourceId, imageView.getContext(),
                new OnDrawableLoadedListener() {
                    ...
                    public void onDrawableLoaded(List<MyFrame> myFrames) {
                        ...
                        animateRawManually(myFrames, imageView,loop, onComplete);
                    }
                });
        return this;
    }
    ...
    private void animateRawManually(List<MyFrame> myFrames,
                                           ImageView imageView, boolean loop,Runnable onComplete) {
        animateRawManually(myFrames, imageView,loop, onComplete, 0);
    }

    //
    private void animateRawManually(final List<MyFrame> myFrames,
                                           final ImageView imageView, final boolean loop, final Runnable onComplete,
