...
public class SDDialogCustom extends SDDialogBase {
    ...
    private SDTimerUtil mTimer = new SDTimerUtil();
    ...
    protected void init() {
        ...
        mTvPrompt = (TextView) mView.findViewById(R.id.dialog_custom_tv_prompt);
        mTvTip = (TextView) mView.findViewById(R.id.dialog_custom_tv_tip);
        mLlContent = (LinearLayout) mView.findViewById(R.id.dialog_custom_ll_content_view);
    ...
    private void initViewStates() {
        ...
        setTextColorCancel(Color.parseColor("#000000"));
        setTextColorConfirm(Color.parseColor("#000000"));

        setTextTitle("提示").setTextConfirm("确定").setTextCancel("取消");
    }

    public void setPromptC(String prompt) {
    ...
    public void showTip(String tip, long time) {
        if (!TextUtils.isEmpty(tip) && time > 0) {
            ...
            mTimer.startWork(time, new SDTimerUtil.SDTimerListener() {
