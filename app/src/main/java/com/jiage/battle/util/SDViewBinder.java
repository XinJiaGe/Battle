...
public class SDViewBinder {
    ...
    public static void setImageView(ImageView imageView, String url) {
        setImageView(url, imageView, ImgConfig.getPortraitLargeOption(), null, null);
    }
    ...
    public static void setImageView(String uri, ImageView imageView, ImageLoadingListener listener) {
        setImageView(uri, imageView, ImgConfig.getPortraitLargeOption(), listener, null);
    }
    public static void setImageView(String uri, ImageView imageView, ImageLoadingProgressListener progressListener) {
        setImageView(uri, imageView, ImgConfig.getPortraitLargeOption(), null, progressListener);
    }
    ...
    public static void setImageView(String uri, ImageView imageView, ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
        setImageView(uri, imageView, ImgConfig.getPortraitLargeOption(), listener, progressListener);
    }
