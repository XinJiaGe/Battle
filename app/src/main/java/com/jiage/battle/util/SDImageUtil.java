...
public class SDImageUtil {
     ...
     * @return
     */
    private Bitmap compressImage(File oldFile, int quality) {
        try {
            Bitmap image = BitmapFactory.decodeFile(oldFile.getAbsolutePath());
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
    ...
    public static Bitmap blurBitmap(Bitmap sentBitmap, int radius, boolean canReuseInBitmap) {
        ...
        //
        // If you are using this algorithm in your icon_scan_code please add
        // the following line:
        //
