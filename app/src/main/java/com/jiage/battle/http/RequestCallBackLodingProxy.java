...
public class RequestCallBackLodingProxy implements Callback.ProgressCallback<String> {
    private static final String STRING_NULL = "\":null";
    private static final String STRING_FALSE = "\":false";
    private static final String STRING_EMPTY_ARRAY = "\":[]";
    private RequestCallBack<String> mOriginalCallBack;

    public RequestCallBackLodingProxy(RequestCallBack<String> originalCallBack) {
...
//            }
    ...
    public void onLoading(long total, long current, boolean isDownloading) {
        if (mOriginalCallBack != null) {
            mOriginalCallBack.onLoading(total, current, isDownloading);
        }
    }
}
