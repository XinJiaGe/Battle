...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    private final LinearLayout optionsTitle;
    ...
    private boolean clickOptionsSelectDismiss = true;
    public OptionsPickerView(Context context) {
        ...
        optionsTitle = (LinearLayout) findViewById(R.id.optionsTitle);
        optionsTitle.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        wheelOptions = new WheelOptions(optionspicker,optionsTitle);
    }
    ...
    public void setPicker(Activity activity,
                          ...
                          boolean linkage) {
        wheelOptions.setPicker(activity,options1Items, options2Items, options3Items,itemTitle,
                linkage);
    }
    public void setPicker(Activity activity,
                          ArrayList<T> options1Items,
                          ...
                          List<String> itemTitle,
                          boolean linkage) {
        wheelOptions.setPicker(activity,options1Items, options2Items, null,itemTitle,
                linkage);
    }
    ...
    public void setClickOptionsSelectDismiss(boolean clickOptionsSelectDismiss) {
        this.clickOptionsSelectDismiss = clickOptionsSelectDismiss;
    }
}
