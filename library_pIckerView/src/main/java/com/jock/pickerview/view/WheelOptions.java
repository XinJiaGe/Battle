...
public class WheelOptions<T> {
	private LinearLayout mOptionsTitle;
	private View view;
	...
	public WheelOptions(View view, LinearLayout optionsTitle) {
		super();
		this.view = view;
		this.mOptionsTitle = optionsTitle;
		setView(view);
	}

	public void setPicker(ArrayList<T> optionsItems) {
		setPicker(null,optionsItems, null, null,null, false);
	}

	public void setPicker(ArrayList<T> options1Items,
			ArrayList<ArrayList<T>> options2Items, boolean linkage) {
		setPicker(null,options1Items, options2Items, null,null, linkage);
	}
	public void setPicker(ArrayList<T> options1Items,
						  ArrayList<ArrayList<T>> options2Items,
						  ArrayList<ArrayList<ArrayList<T>>> options3Items,
						  boolean linkage) {
		setPicker(null,options1Items, options2Items, options3Items,null, linkage);
	}
	public void setPicker(Activity activity,
		...
		if(itemTitle!=null&&mOptionsTitle!=null){
			mOptionsTitle.removeAllViews();
			for (String s : itemTitle) {
				View titlell = LayoutInflater.from(activity).inflate(R.layout.item_title, null);
				titlell.setLayoutParams(new LinearLayout.LayoutParams(0, GridLayout.LayoutParams.WRAP_CONTENT,1));
				TextView textView = (TextView)titlell.findViewById(R.id.item_title_title);
				textView.setText(s);
				mOptionsTitle.addView(titlell);
			}
		}
		// 选项1
