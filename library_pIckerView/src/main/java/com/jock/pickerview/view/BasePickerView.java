...
public class BasePickerView
{
	...
	private boolean isShowShow = false;
	 ...
	 *            这个View
	 */
	private void onAttached(LinearLayout v , View view)
	{
		this.mLL = v;
		v.addView(view);
	...
	public void setShowShow(boolean showShow) {
		isShowShow = showShow;
	}
}
